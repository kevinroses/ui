...
export default function OffRampScreen({
  ...
  const noStorefrontCopy =
    'On your Jolders store you’ll be able to list and sell your NFTs. Setting up a store only takes 5 min and is totally free!';
    ...
    if (successfulMints) {
      ...
      if (storefront) {
        ...
        return (
          <Button
            type="primary"
            onClick={() => (window.location.href = 'https://nft.jolders.com/storefront/new')}
          >
